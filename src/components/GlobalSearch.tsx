                ...
                return (
                  ...
                  >
                    <div className={cn(
                      ...
                      result.type === 'upload' && 'bg-blue-100 dark:bg-blue-900/30 text-blue-600',
                      result.type === 'lesson' && 'bg-green-100 dark:bg-green-900/30 text-green-600',
                      result.type === 'flashcard' && 'bg-purple-100 dark:bg-purple-900/30 text-purple-600',
                      result.type === 'quiz' && 'bg-orange-100 dark:bg-orange-900/30 text-orange-600'
                    )}>
